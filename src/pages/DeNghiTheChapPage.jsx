...
function getFriendlyError(error) {
  ...
  if (message.length > 160) {
    return 'AppSheet trả về lỗi khi tải hồ sơ đề nghị thế chấp. Vui lòng kiểm tra lại cấu hình và quyền truy cập.';
  }
  return message;
}
            ...
            <div className="flex min-w-[280px] flex-1 items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <CardDescription className="mt-1 text-slate-500">
                  {idHoSoTheChap ? `Đã tải hồ sơ ${idHoSoTheChap}.` : 'Nhập ID_HoSoTheChap để tải dữ liệu từ AppSheet.'}
                </CardDescription>
              </div>
            </div>
