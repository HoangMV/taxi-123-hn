...
import { ArrowRight, BookMarked, Car, FileText, Gauge, GraduationCap, Landmark, HandCoins, IdCard, LayoutDashboard, ScrollText, ShieldCheck } from 'lucide-react';
...
const actions = [
  {
    ...
    description: 'Xem tổng quan nhân sự, phương tiện, cảnh báo hết hạn và xuất báo cáo quản trị QLVT.',
