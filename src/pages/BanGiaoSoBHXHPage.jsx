...
function getFriendlyError(error) {
  ...
  if (message.length > 160) {
    return 'AppSheet trả về lỗi khi tải biên bản bàn giao sổ BHXH. Vui lòng kiểm tra lại cấu hình và quyền truy cập.';
  }
  return message;
}
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="flex min-w-[280px] flex-1 items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <CardDescription className="mt-1 text-slate-500">
                  {idBanGiaoSo ? `Đã tải biên bản ${idBanGiaoSo}.` : 'Nhập ID_BanGiaoSo để tải dữ liệu từ AppSheet.'}
                </CardDescription>
              </div>
            </div>
      ...
      {payload && !loading && (
        <>
          {loadingRelated && (
            <Card className="bhxh-actions border-violet-200 bg-violet-50/80">
              <CardContent className="p-4">
                <div className="flex items-center gap-3 text-violet-900">
                  <RefreshCw className="h-4 w-4 animate-spin text-violet-700" />
