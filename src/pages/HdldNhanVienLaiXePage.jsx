...
function getFriendlyError(error) {
  ...
  if (message.length > 160) {
    return 'AppSheet trả về lỗi khi tải HĐLĐ nhân viên lái xe. Vui lòng kiểm tra lại cấu hình và quyền truy cập.';
  }
  return message;
}
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="flex min-w-[280px] flex-1 items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <CardDescription className="mt-1 text-slate-500">
                  {idHopDongLaoDong ? `Đã tải hợp đồng ${idHopDongLaoDong}.` : 'Nhập ID_HopDongLaoDong để tải dữ liệu từ AppSheet.'}
                </CardDescription>
              </div>
            </div>
      ...
      {payload && !loading && (
        <>
          {loadingRelated && (
            <Card className="hdld-actions border-indigo-200 bg-indigo-50/80">
